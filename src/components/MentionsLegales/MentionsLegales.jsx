  ...
  return (
    <div className="Mentions">
      ...
      <p>
        ...
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> met à
      ...
      <p>
        ...
        détenues par <a href="http://www.swiper.fr">http://www.swiper.fr</a>{" "}
      ...
      <p>
        ...
        site internet <a href="http://www.swiper.fr">http://www.swiper.fr</a>{" "}
        l'identité des différents intervenants dans le cadre de sa réalisation
        et de son suivi:
      </p>
      <strong>Propriétaire</strong> : Guilhem, Lucas, Coralie, Maxime – 9 Rue
      des Olivettes 44000 Nantes
      <br />
      <strong>Responsable publication</strong> : Guilhem, Lucas, Coralie, Maxime
      – guilhemcvdv@outlook.com
      <br />
      Le responsable publication est une personne physique ou une personne
      morale.
      <br />
      <strong>Webmaster</strong> : Guilhem, Lucas, Coralie, Maxime –
      guilhemcvdv@outlook.com
      <br />
      <strong>Hébergeur</strong> : Github – https://www.github.com 44000 Nantes
      020202020202
      <br />
      <strong>Délégué à la protection des données</strong> : Guilhem, Lucas,
      Coralie, Maxime – guilhemcvdv@outlook.com
      <br />
      ...
      <p>
        ...
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> implique
        ...
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> sont donc
      ...
      <p>
        ...
        <a href="http://www.swiper.fr">http://www.swiper.fr</a>, qui s’efforcera
        alors de communiquer préalablement aux utilisateurs les dates et heures
        de l’intervention. Le site web{" "}
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> est mis à jour
        régulièrement par{" "}
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> responsable. De
      ...
      <p>
        Le site internet <a href="http://www.swiper.fr">http://www.swiper.fr</a>{" "}
        a pour objet de fournir une information concernant l’ensemble des
        activités de la société.
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> s’efforce de
        fournir sur le site{" "}
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> des informations
        ...
        jour, qu’elles soient de son fait ou du fait des tiers partenaires qui
        lui fournissent ces informations.
      </p>
      <p>
        Toutes les informations indiquées sur le site{" "}
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> sont données à
        titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les
        renseignements figurant sur le site{" "}
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> ne sont pas
      ...
      <p>
        ...
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> est hébergé chez
        un prestataire sur le territoire de l’Union Européenne conformément aux
      ...
      <p>
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> et l’hébergeur
        ne pourront être tenus responsables en cas de dysfonctionnement du
        réseau Internet, des lignes téléphoniques ou du matériel informatique et
        de téléphonie lié notamment à l’encombrement du réseau empêchant l’accès
        au serveur.
      </p>
      <h2>5. Propriété intellectuelle et contrefaçons.</h2>
      <p>
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> est propriétaire
        des droits de propriété intellectuelle et détient les droits d’usage sur
        ...
        <a href="http://www.swiper.fr">http://www.swiper.fr</a>.
      </p>
      <p>
      ...
      <p>
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> agit en tant
        qu’éditeur du site.{" "}
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> est responsable
        de la qualité et de la véracité du Contenu qu’il publie.{" "}
      </p>
      <p>
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> ne pourra être
        tenu responsable des dommages directs et indirects causés au matériel de
        l’utilisateur, lors de l’accès au site internet{" "}
        <a href="http://www.swiper.fr">http://www.swiper.fr</a>, et résultant
      ...
      <p>
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> ne pourra
        également être tenu responsable des dommages indirects (tels par exemple
        qu’une perte de marché ou perte d’une chance) consécutifs à
        l’utilisation du site{" "}
        <a href="http://www.swiper.fr">http://www.swiper.fr</a>. Des espaces
        interactifs (possibilité de poser des questions dans l’espace contact)
        sont à la disposition des utilisateurs.{" "}
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> se réserve le
        ...
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> se réserve
      ...
      <p>
        ...
        responsable du traitement des Données Personnelles est : Guilhem, Lucas,
        Coralie, Maxime. <a href="http://www.swiper.fr">http://www.swiper.fr</a>
        est représenté par Guilhem, Lucas, Coralie, Maxime, son représentant
        légal
      </p>
      <p>
        En tant que responsable du traitement des données qu’il collecte,{" "}
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> s’engage à
        ...
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> traite des
        Données Personnelles,{" "}
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> prend toutes les
        ...
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> les traite.
      </p>
      <h3>7.2 Finalité des données collectées</h3>
      <p>
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> est susceptible
      ...
      <ul>
        ...
        <li>
          ...
          <a href="http://www.swiper.fr">http://www.swiper.fr</a> : adresse
          email{" "}
        </li>
        <li>
      ...
      <p>
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> ne commercialise
      ...
      <p>
        ...
        de <a href="http://www.swiper.fr">http://www.swiper.fr</a> disposent des
        droits suivants :{" "}
      </p>
      <ul>
        <li>
        ...
        <li>
          ...
          et de choisir à qui{" "}
          <a href="http://www.swiper.fr">http://www.swiper.fr</a> devra
          communiquer (ou non) ses données à un tiers qu’ils aura préalablement
          désigné
        </li>
      </ul>
      <p>
        Dès que <a href="http://www.swiper.fr">http://www.swiper.fr</a> a
        connaissance du décès d’un Utilisateur et à défaut d’instructions de sa
        part, <a href="http://www.swiper.fr">http://www.swiper.fr</a> s’engage à
        détruire ses données, sauf si leur conservation s’avère nécessaire à des
        fins probatoires ou pour répondre à une obligation légale.
      </p>
      <p>
        Si l’Utilisateur souhaite savoir comment{" "}
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> utilise ses
        Données Personnelles, demander à les rectifier ou s’oppose à leur
        traitement, l’Utilisateur peut contacter{" "}
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> par écrit à
        l’adresse suivante :{" "}
      </p>
      Guilhem, Lucas, Coralie, Maxime – DPO, Guilhem, Lucas, Coralie, Maxime
      <br />9 Rue des Olivettes 44000 Nantes.
      <p>
        Dans ce cas, l’Utilisateur doit indiquer les Données Personnelles qu’il
        souhaiterait que <a href="http://www.swiper.fr">http://www.swiper.fr</a>{" "}
      ...
      <p>
        ...
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> reste libre du
      ...
      <p>
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> s’engage à
        prendre toutes les précautions nécessaires afin de préserver la sécurité
        ...
        l’intégrité ou la confidentialité des Informations du Client est portée
        à la connaissance de{" "}
        <a href="http://www.swiper.fr">http://www.swiper.fr</a>, celle-ci devra
        dans les meilleurs délais informer le Client et lui communiquer les
        mesures de corrections prises. Par ailleurs{" "}
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> ne collecte
        aucune « données sensibles ».
      </p>
      <p>
        Les Données Personnelles de l’Utilisateur peuvent être traitées par des
        filiales de <a href="http://www.swiper.fr">http://www.swiper.fr</a> et
      ...
      <p>
        ...
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> sont
      ...
      <p>
        ...
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> n'est publiée à
        ...
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> et de ses droits
        ...
        du site <a href="http://www.swiper.fr">http://www.swiper.fr</a>.
      </p>
      <h3>Sécurité</h3>
      <p>
        Pour assurer la sécurité et la confidentialité des Données Personnelles
        et des Données Personnelles de Santé,{" "}
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> utilise des
      ...
      <p>
        Le site <a href="http://www.swiper.fr">http://www.swiper.fr</a> contient
        un certain nombre de liens hypertextes vers d’autres sites, mis en place
        avec l’autorisation de{" "}
        <a href="http://www.swiper.fr">http://www.swiper.fr</a>. Cependant,{" "}
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> n’a pas la
      ...
      <p>
        ...
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> d’améliorer le
      ...
      <p>
        ...
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> informe
      ...
      <p>
        ...
        être le cas lorsque{" "}
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> ou l’un de ses
      ...
      <p>
        Le cas échéant, <a href="http://www.swiper.fr">http://www.swiper.fr</a>{" "}
        ...
        par <a href="http://www.swiper.fr">http://www.swiper.fr</a>, résultant
        (i) du refus de Cookies par l’Utilisateur (ii) de l’impossibilité pour{" "}
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> d’enregistrer ou
      ...
      <p>
        ...
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> pourra en outre
      ...
      <p>
        ...
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> ou dans son
        ...
        de <a href="http://www.swiper.fr">http://www.swiper.fr</a>, Twitter,
      ...
      <p>
        ...
        <a href="http://www.swiper.fr">http://www.swiper.fr</a>. À tout moment,
        l’Utilisateur peut néanmoins revenir sur son consentement à ce que{" "}
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> dépose ce type
        de cookies.
      </p>
      <h3>Article 9.2. BALISES (“TAGS”) INTERNET</h3>
      <p>
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> peut employer
        occasionnellement des balises Internet (également appelées « tags », ou
        balises d’action, GIF à un pixel, GIF transparents, GIF invisibles et
        GIF un à un) et les déployer par l’intermédiaire d’un partenaire
      ...
      <p>
        ...
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> d’évaluer les
      ...
      <p>
        ...
        <a href="http://www.swiper.fr">http://www.swiper.fr</a>, et fournir
      ...
      <p>
        ...
        <a href="http://www.swiper.fr">http://www.swiper.fr</a> est soumis au
